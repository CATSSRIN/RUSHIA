            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <form method="POST" action="{{ route('admin.ransum.upload') }}" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-end">
                        ...
                        <button type="submit" class="inline-flex items-center px-5 py-2.5 bg-[#217a68] hover:bg-[#1b6455] text-white text-sm font-medium rounded-lg transition whitespace-nowrap shadow-sm">
                    ...
                    @foreach($uploads as $upload)
                        ...
                        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition duration-200">
                            ...
                            <div class="p-6 grid gap-6 xl:grid-cols-[1.1fr_1fr_1.1fr]">
                                <!-- Col 1: Detail Kapal -->
                                <div class="space-y-4">
                                    <div class="xl:h-[52px] flex flex-col justify-end">
                                ...
                                <div>
                                    <div class="xl:h-[52px] flex items-end justify-between pb-1">
                                    ...
                                    @else
                                        <div class="rounded-xl border border-dashed border-gray-200 p-6 text-center text-xs text-gray-400 flex flex-col items-center justify-center h-28 mt-4">
                                ...
                                <div>
                                    ...
                                    @if($poCount > 0)
                                        <div class="space-y-2 max-h-48 overflow-y-auto pr-1 mt-4">
