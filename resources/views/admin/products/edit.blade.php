                ...
                <form method="POST" action="{{ route('admin.products.update', $product) }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="kode" name="kode" type="text" class="mt-1 block w-full" :value="old('kode', $product->kode)" placeholder="e.g. BK010002" />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="harga_supplier" name="harga_supplier" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('harga_supplier', $product->harga_supplier)" />
                                <x-input-error :messages="$errors->get('harga_supplier')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="harga_jual" :value="__('Harga Jual (Rp)')" />
                                <x-text-input id="harga_jual" name="harga_jual" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('harga_jual', $product->harga_jual)" required />
